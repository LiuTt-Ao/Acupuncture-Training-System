...
// AcupunctureArm-v3View.h : interface of the CAcupunctureArmv3View class
//
...
protected: // create from serialization only
	...
	DECLARE_DYNCREATE(CAcupunctureArmv3View)

// Attributes
public:
	CAcupunctureArmv3Doc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in AcupunctureArm-v3View.cpp
inline CAcupunctureArmv3Doc* CAcupunctureArmv3View::GetDocument() const
   { return reinterpret_cast<CAcupunctureArmv3Doc*>(m_pDocument); }
#endif
