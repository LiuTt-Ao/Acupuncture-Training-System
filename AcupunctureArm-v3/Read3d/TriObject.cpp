...
void CTriObject::drawGL()
{
	...
	if (normalapplied)
	{
		...
		glBegin(GL_TRIANGLES);
			...
			{
				j = 3*i;
				if(materialsapplied) glColor4f( materials[matfaces[i]].diffuseColor[0], materials[matfaces[i]].diffuseColor[1], materials[matfaces[i]].diffuseColor[2], 1.0-materials[matfaces[i]].transparency );
...
void CTriObject::setMaterial(BOOL apply)
{
	materialsapplied = apply;
}
